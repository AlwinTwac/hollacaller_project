...
const { ExpressPeerServer } = require('peer'); // Use Express wrapper
...
// Enable CORS for everyone (Fixes 'Access-Control-Allow-Origin' error)
app.use(cors({
    origin: true,
...
// We use ExpressPeerServer to attach to the existing 'server'
// This prevents port conflicts and 404 errors on the API
